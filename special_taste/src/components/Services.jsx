  ...
  return (
    <div className='px-32 py-20'>
        <div className="flex flex-col justify-center items-center">
            <h1 className='text-3xl font-semibold mb-4'>WE DESIGN DELICIOUS</h1>
        ...
        <div className='flex gap-12 justify-center items-center p-20 -mt-4'>
            <div class="max-w-sm bg-white border-[0.1px] border-gray-200 text-center rounded-lg shadow-sm">
                <a href="#">
